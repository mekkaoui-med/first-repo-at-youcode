 ...
 *
 * 🎯 MISSION
 * Un utilisateur tente d'accéder au back-office. Déclarez trois variables
 *  : estAdmin = false, estModerateur = true, et motDePasseValide = true.
...
if (motDePasseValide == true && (estAdmin == true || estModerateur == true)){
