 ...
 * 4. (Bonus) Créez une fonction afficherQuantites() qui compte et affiche le panier
 * sous forme : Article 101 : 2 exemplaires, Article 105 : 1 exemplaire...
 *
...
function ajouterAuPanier(panier, id) {
  panier[panier.length] = id;
  return panier;
}
function retirerDuPanier(panier, id) {
  let newpanier = panier.filter((e) => e !== id);
  return newpanier;
}

console.log(ajouterAuPanier(panier, 103));
console.log(retirerDuPanier(panier, 101));
