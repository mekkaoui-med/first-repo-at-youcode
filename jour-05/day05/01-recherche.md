...
**Ma réponse :
    -> le premier élément d'un tableau se trouve a l'index 0.
**
...
**Ma réponse : 
-> la difference entre .pop() et .shift() est .pop() supprime la dernier élément , par contre .shift() supprime le primier élément.
**
...
**Ma réponse :
 ->  .length d'un tableau vide '[]' est egale a 0
**
...
**Ma réponse : 
-> la différence entre 'for...in' and 'for...of' , 
**
