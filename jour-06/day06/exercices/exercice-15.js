...
const apiResponse = '{"id":1, "titre":"Apprendre le JS", "vu":false}';
const apiResponseOpjet = JSON.parse(apiResponse);
console.log(typeof apiResponseOpjet);
console.log(apiResponseOpjet);
apiResponseOpjet.vu = true;
console.log(apiResponseOpjet);
const result = JSON.stringify(apiResponseOpjet);
console.log(result)